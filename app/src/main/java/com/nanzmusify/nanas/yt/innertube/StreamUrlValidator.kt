 ...
 * disederhanakan untuk NanzMusify yang anonim (tanpa cookie → tidak ada header `Cookie`).
 *
 * ## Kenapa "ada URL" belum berarti "bisa diputar"
 *
 * Diagnostik NanzMusify sebelumnya menyebut klien `USABLE` begitu response membawa
...
internal object StreamUrlValidator {
     ...
     *
     * NanzMusify tidak memasang chunk length khusus, jadi `DefaultLoadControl` memulai dengan
