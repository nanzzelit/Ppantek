 ...
 * ("lirik gak singkron").
 */
class LrcLibProvider : NanzMusifyLyricsProvider {

    override val name: String = "LRCLIB"
    override val priority: Int = 10

    private val client get() = NanzMusifyHttp.extractClient
    ...
    private companion object {
        ...
        const val USER_AGENT = "NanzMusify Android (github.com/Nanas/Lyra)"
    }
}
