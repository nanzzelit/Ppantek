 ...
 */
package com.nanzmusify.nanas.lyrics
...
class LyricsRepository(
    ...
    private val providers: List<NanzMusifyLyricsProvider> = listOf(
        LrcLibProvider(),
    ...
    suspend fun lyrics(track: NanzMusifyTrack): LyricsResult = withContext(Dispatchers.IO) {
    ...
    private suspend fun search(track: NanzMusifyTrack): LyricsResult {
    ...
    private fun buildQuery(track: NanzMusifyTrack): LyricsQuery {
