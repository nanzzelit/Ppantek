...
object NanzMusifyArchive {

    val genres = listOf(
        NanzMusifyGenre("g1", "JAZZ", "Nocturne brass & smoke", R.drawable.cover_jazz, "jazz classics vinyl"),
        NanzMusifyGenre("g2", "ELECTRONIC", "Modular pulse fields", R.drawable.cover_electronic, "electronic ambient mix"),
        NanzMusifyGenre("g3", "CLASSICAL", "Strings & piano", R.drawable.cover_classical, "classical chamber music"),
        NanzMusifyGenre("g4", "INDIE", "Amplifier residue", R.drawable.cover_indie, "indie rock essentials"),
        NanzMusifyGenre("g5", "HIP-HOP", "Studio midnight gold", R.drawable.cover_hiphop, "hip hop classics"),
        NanzMusifyGenre("g6", "AMBIENT", "Fog architecture", R.drawable.cover_ambient, "ambient sleep music"),
    )
