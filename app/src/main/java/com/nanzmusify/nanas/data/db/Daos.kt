 ...
 */
package com.nanzmusify.nanas.data.db
...
interface LibraryDao {
    ...
    @Query("SELECT videoId FROM liked_tracks")
    suspend fun likedIdsOnce(): List<String>
...
interface DownloadDao {
    ...
    @Query("SELECT * FROM downloads WHERE state = 'DONE' ORDER BY createdAt DESC")
    suspend fun doneOnce(): List<DownloadEntity>
