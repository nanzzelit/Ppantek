...
internal object InnertubeConfig {
     ...
     * dari IP residensial Indonesia. Karena itu NanzMusify mengambilnya dari sumber yang sama
    ...
    fun ensureVisitorData(ioClient: okhttp3.OkHttpClient, userAgent: String) {
        ...
        // Cadangan: endpoint `guide` di www (perilaku NanzMusify sebelumnya).
        runCatching {
            val req = Request.Builder()
     ...
     * NanzMusify memindai jalur itu lebih dulu, lalu melakukan pemindaian terbatas ke
