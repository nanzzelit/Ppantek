# notes/ — memori proyek NanzMusify

Folder ini adalah **memori kerja** NanzMusify: apa yang pernah salah, apa yang sudah benar
...
| [`05-peta-fitur-diinginkan.md`](05-peta-fitur-diinginkan.md) | 20 fitur yang diminta: status di NanzMusify, padanannya di Meld, usaha, dan 2 konflik kebijakan | Saat merencanakan fitur baru |
...
```
app/src/main/java/com/nanzmusify/nanas/
├─ core/         ServiceLocator (DI manual), LocaleHelper, SessionStore
├─ data/         LibraryRepository, db/{Daos,Entities,NanzMusifyDatabase}, model/, settings/, taste/
├─ download/     NanzMusifyDownloadManager, HlsFlatDownloader
...
└─ yt/           YouTubeRepository, NanzMusifyHttp, innertube/ (5 berkas — JANTUNG streaming)
